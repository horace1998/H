      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col gap-10">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-zinc-100 pb-8">
          <div className="flex flex-col gap-1">
            <h1 className="text-2xl font-extrabold tracking-tighter uppercase">{t.common.home}</h1>
            <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest text-zinc-400">{activeConfig.terminology.homeHeader}</p>
          </div>
