...
export default function SynkOracle() {
  const { memories, goals, addMemory, deleteMemory, user, stats, bias, language } = useSYNK();
    ...
    <div className="w-full h-full flex flex-col p-6 lg:p-10 pb-32 overflow-y-auto custom-scrollbar overflow-x-hidden bg-white text-zinc-900">
      <div className="max-w-6xl mx-auto w-full flex flex-col gap-10">
        ...
        <header className="flex flex-col gap-2">
          <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">{activeConfig.terminology.galleryLabel}</span>
          <h1 className="text-2xl font-extrabold tracking-tighter uppercase font-mono">Channel // {activeConfig.terminology.galleryLabel.toUpperCase()}</h1>
        </header>
